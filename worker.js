...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to the team Rita and Stephen';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/Donchess1/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by Ritapossible',
      '<a href="https://https://github.com/Ritapossible</a>. ',
